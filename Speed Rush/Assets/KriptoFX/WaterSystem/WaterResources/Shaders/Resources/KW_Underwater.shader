...
#include "KW_WaterHelpers.cginc"
	...
	half4 frag(v2f i) : SV_Target
	{
		...
		//return float4(tex2D(KW_VolumetricLight, i.uv.xy).rgb, 1);
	...
	//return 1;
		...
		float3 volumeScattering = tex2D(KW_VolumetricLight, i.uv.xy - float2(0, halfMask * 0.1 + KW_VolumetricLight_TexelSize.y * 5)).rgb;
#else
